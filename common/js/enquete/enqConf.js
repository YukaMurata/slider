function enqCheck(){
	...
	var ckName="enqConfFlg_201610_pc"; 
	if(checkCookie(ckName) == ""){
		...
		if(yfl){
			...
			//var chDat = ckName+"=viewEnd; expires=" + dt.toGMTString();
			var chDat = ckName+"=viewEnd; path=/; expires=" + dt.toGMTString();
			document.cookie = chDat;
			tb_show("", "/enquete_confirm.html?keepThis=true&TB_iframe=true&height=270&width=500", "");
		}
	}
};
